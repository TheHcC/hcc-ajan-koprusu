...
- **konu** — kısa, tireli
- **vN** — aynı yazarın aynı konudaki versiyonu. Revizyon yeni versiyon açar; eski versiyon silinmez.

Direktifler:

`YYYY-MM-DD_DIREKTIF_KIMDEN-to-KIME_konu_vN.md`
...
| `2026-09-25_DIREKTIF_CLAUDE-Opus-5.5-to-CLAUDE-CODE_N1-N3-uygulama_v1.md` | Claude.ai → Claude Code | uygulama direktifi | Drive/Obsidian'da mevcut; public GitHub aynası güvenlik sanitizasyonu bekliyor |
...
| `2026-09-25_CHATGPT-gpt-5.6-sol_claude-opus-5.5-normalizasyon-analizi-degerlendirmesi_v1.md` | ChatGPT (GPT-5.6 Sol) | Claude analizinin karşı-değerlendirmesi | değerlendirme |
...
Branch:
`sistem-analizi/n1-n3`

Klasör:
`sistem-analizi/`

Public mirror kuralı: hassas veya kişisel tanımlayıcı içeren dosya sanitise edilmeden public repo'ya konulmaz. Bu nedenle Claude Code uygulama direktifinin Drive kopyası, içerdiği yerel kullanıcı yolu ve private Drive klasör kimliği nedeniyle şu aşamada aynalanmamıştır.

## Sürüm ilkesi

- İçerik revizyonunda `v2`, `v3` şeklinde yeni sürüm açılır.
- Eski model çıktısı silinmez.
- Bir modelin başka bir model çıktısına yaptığı değerlendirme ayrı dosyadır; kaynak metnin üzerine yazılmaz.
